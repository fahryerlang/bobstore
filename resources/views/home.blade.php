    ...
    <section class="bg-gradient-to-br from-gray-50 to-blue-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-2 gap-8 items-start">
                ...
                <div class="bg-gradient-to-br from-[#F87B1B] to-orange-600 rounded-3xl p-8 shadow-2xl">
                    <div class="grid grid-cols-2 gap-4">
                        <!-- Card 1 -->
                        <div class="bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <h4 class="font-bold text-gray-900 mb-1 text-sm">Tepat Sasaran</h4>
                            <p class="text-xs text-gray-600">Produk sesuai kebutuhan</p>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <h4 class="font-bold text-gray-900 mb-1 text-sm">Pengiriman Cepat</h4>
                            <p class="text-xs text-gray-600">Proses kilat & aman</p>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <h4 class="font-bold text-gray-900 mb-1 text-sm">Produk Original</h4>
                        ...
                        <div class="bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <h4 class="font-bold text-gray-900 mb-1 text-sm">Rating Tinggi</h4>
                            <p class="text-xs text-gray-600">Kepuasan pelanggan</p>
                        </div>
                    </div>
                </div>
